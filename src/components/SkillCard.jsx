...
export default function SkillCard({ title, description, icon, color, category }) {
  return (
    <div className={`bg-white/95 backdrop-blur-md border border-gray-200/50 rounded-xl p-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 hover:rotate-1 skill-card`}>
